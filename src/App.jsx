        ...
        <div className='cart-item'>
          <div className='cart-item-info'>
            ...
            <div className='cart-text'>
              <p className='cart-item-quantity color-red no-margin'>
                {dessert.quantity}x
              </p>
              <p className='cart-item-cost no-margin'>
                @ ${dessert.price.toFixed(2)}
              </p>
              <p className='cart-item-total no-margin'>
    ...
    <main className='app-container'>
      <div className='desserts-and-cart'>
        <div className='desserts-container'>
          <h1>Desserts</h1>
          <div className='all-desserts'>{DessertElements}</div>
        </div>
          ...
          <div className='cart'>
            ...
            {cartElements.length > 0 ? (
              <div>
                ...
                <button
                  className='confirm-btn background-red red-btn'
      ...
      <div className={`confirmation-modal-overlay ${openModal}`}>
        <div className='confirmation-modal'>
          ...
          <button
            className='new-order-btn background-red red-btn'
            onClick={() => newOrder()}
          >
            Start New Order
          </button>
